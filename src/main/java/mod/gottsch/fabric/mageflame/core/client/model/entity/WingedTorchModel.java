...
public class WingedTorchModel<T extends Entity> extends EntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData rightTip = rightWing.addChild("rightTip", ModelPartBuilder.create().uv(0, 13).mirrored().cuboid(-3.0F, -2.0F, -0.5F, 3.0F, 4.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(-5.0F, 1.5F, 0.5F, 0.0F, -0.2618F, 0.0F));
	...
	public static void bob(ModelPart part, float originY, float age) {
		part.yaw = originY + (MathHelper.cos(age * 0.25F) * 0.5F + 0.05F);
	}
