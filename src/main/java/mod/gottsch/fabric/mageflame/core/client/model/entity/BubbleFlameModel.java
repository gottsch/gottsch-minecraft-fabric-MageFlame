...
public class BubbleFlameModel<T extends SummonedFlyingEntity> extends EntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData main = modelPartData.addChild("main", ModelPartBuilder.create().uv(0, 0).cuboid(-2.5F, -5.0F, -2.5F, 5.0F, 5.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
		ModelPartData flame = main.addChild("flame", ModelPartBuilder.create().uv(0, 11).cuboid(-1.0F, -2.75F, -1.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -0.75F, 0.0F));
