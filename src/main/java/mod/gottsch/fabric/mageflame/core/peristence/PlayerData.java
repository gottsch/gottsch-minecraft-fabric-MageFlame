...
public class PlayerData {
    ...
    public Optional<SummonedEntityData> register(UUID key, SummonedEntityData value) {
        ...
        Optional o = Optional.ofNullable(entityRegistry.put(key, value));
        MageFlame.LOGGER.info("entity registry -> {}", entityRegistry);
        return o;
    }
    ...
    public void loadNbt(NbtCompound nbt) {
        nbt.getKeys().forEach(key -> {
            ...
            MageFlame.LOGGER.info("processing key -> {}", key);
