...
public class GreaterFlameScroll extends SummonFlameBaseItem {
	...
	public void appendBaseText(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
		...
		tooltip.add(new TranslatableText(LangUtil.tooltip("greater_revelation.desc")).formatted(Formatting.YELLOW));
		...
		tooltip.add(new TranslatableText(LangUtil.tooltip("lifespan"), ticksToTime(36000))); //Config.SERVER.mageFlameLifespan.get())));
	}
