 ...
 *
 */
public class WingedTorchFlameFeatureRenderer<M extends WingedTorchModel> extends EyesFeatureRenderer<LivingEntityRenderState, M> {
	private static final RenderLayer SKIN = RenderLayer.getEyes(Identifier.of("mageflame","textures/entity/winged_torch_flame.png"));

	public WingedTorchFlameFeatureRenderer(FeatureRendererContext<LivingEntityRenderState, M> featureRendererContext) {
